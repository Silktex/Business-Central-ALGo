report 50202 "Sales Invoice With Comment"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/50202_Report_SalesInvoiceWithComment.rdlc';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Comment1; txtComment[1])
                    {
                    }
                    column(Comment2; txtComment[2])
                    {
                    }
                    column(Comment3; txtComment[3])
                    {
                    }
                    column(Comment4; txtComment[4])
                    {
                    }
                    column(Comment5; txtComment[5])
                    {
                    }
                    column(Comment6; txtComment[6])
                    {
                    }
                    column(Comment7; txtComment[7])
                    {
                    }
                    column(Comment8; txtComment[8])
                    {
                    }
                    ...
                    column(recCustomer_Address2; recCustomer."Address 2")
                    {
                    }
                    ...
                    dataitem(SalesInvLine; "Integer")
                    {
                        ...
                        column(TempSalesInvoiceLine_Description2; TempSalesInvoiceLine."Description 2")
                        {
                        }
                        ...
                        column(SalesInvoiceLine_LineDiscountAmount; "Sales Invoice Line"."Line Discount Amount")
                        {
                        }
    ...
    var
        ...
        txtComment: array[50] of Text[1024];
        intLineCount: Integer;
        txtProductGroup: Text[20];
