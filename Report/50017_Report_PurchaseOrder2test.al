report 50017 "Purchase Order2 test"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/50017_Report_PurchaseOrder2test.rdlc';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(CompanyPhoneNo; recCompany."Phone No.")
            {
                IncludeCaption = true;
            }
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        begin
                            ...
                            //recPline.RESET;
                            //recPline.SETRANGE(recPline."Document No.","Document No.");
                            //IF recPline.FIND('-') THEN
                            //   taxpline+= "Tax Amount";
                        end;
