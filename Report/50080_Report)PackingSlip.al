report 50080 "Packing Slip"
{
    ...
    dataset
    {
        dataitem(PostWSH; "Posted Whse. Shipment Header")
        {
            ...
            begin
                ComInfo.GET();
                SSH.RESET;
                SSH.SETRANGE("Warehouse Shipment No.", PostWSH."Whse. Shipment No.");
                ...
                RWAL.SETRANGE("Whse. Document No.", PostWSH."Whse. Shipment No.");
    ...
    begin
        HeaderText := ('^XA' +
                  ...
                  '^CFA,30' +
                  '^FB812,1,0,C,0^FO0,80^FDShipment# ' + PostWSH."Whse. Shipment No." + '^FS' +
                  '^CFA,15' +
