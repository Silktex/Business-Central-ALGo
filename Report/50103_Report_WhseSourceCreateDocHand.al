report 50103 "Whse.-Source - Create Doc Hand"
{
    ...
    begin
        WITH WhseItemTrackingLine DO BEGIN
            ...
            SetSourceFilter(WhseWorksheetLine."Worksheet Template Name", -1);
            ...
            REPEAT
                ...
                TrackedQtyInBin := WarehouseAvailabilityMgt.CalcQtyOnBin(
                    ...
                    WhseWorksheetLine."Variant Code", WhseItemTrackingSetup);// ReservationEntry);// "Lot No.", "Serial No.");
                IF TrackedQtyInBin < "Quantity (Base)" + CalcQtyAssignedToMove(
    ...
    procedure GetActivityNo() FirstActivityNo: Code[20]
    begin
        IF FirstActivityNo <> '' THEN
            EXIT(FirstActivityNo);
    end;
