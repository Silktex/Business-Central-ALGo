report 50206 "Sales Invoice Com New"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/50206_Report_SalesInvoiceComNew.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesInvLine; "Integer")
                    {
                        ...
                        column(VAT_TempSalesInvoiceLine; ROUND(TempSalesInvoiceLine."VAT %", 0.5))
                        {
                        }
                      ...
                      END;
                            */
                            ...
                            VATAmountLine.INIT;
                            VATAmountLine."VAT Identifier" := TempSalesInvoiceLine."VAT Identifier";
                            VATAmountLine."VAT Calculation Type" := TempSalesInvoiceLine."VAT Calculation Type";
                            VATAmountLine."Tax Group Code" := TempSalesInvoiceLine."Tax Group Code";
                            VATAmountLine."VAT %" := TempSalesInvoiceLine."VAT %";
                            VATAmountLine."VAT Base" := TempSalesInvoiceLine.Amount;
                            VATAmountLine."Amount Including VAT" := TempSalesInvoiceLine."Amount Including VAT";
                            VATAmountLine."Line Amount" := TempSalesInvoiceLine."Line Amount";
                            IF TempSalesInvoiceLine."Allow Invoice Disc." THEN
                                VATAmountLine."Inv. Disc. Base Amount" := TempSalesInvoiceLine."Line Amount";
                            VATAmountLine."Invoice Discount Amount" := TempSalesInvoiceLine."Inv. Discount Amount";
                            VATAmountLine.InsertLine;

                            //TotalSubTotal += "Line Amount";
                            //TotalInvoiceDiscountAmount -= "Inv. Discount Amount";
                            //TotalAmount += Amount;
                            TotalAmountVAT += TempSalesInvoiceLine."Amount Including VAT" - TempSalesInvoiceLine.Amount;
                            TotalAmountInclVAT += TempSalesInvoiceLine."Amount Including VAT";
                            TotalPaymentDiscountOnVAT += -(TempSalesInvoiceLine."Line Amount" - TempSalesInvoiceLine."Inv. Discount Amount" - TempSalesInvoiceLine."Amount Including VAT");

                            //MESSAGE('TotalAmountVAT  %1,....TotalAmountInclVAT  %2....TotalPaymentDiscountOnVAT  %3',TotalAmountVAT,TotalAmountInclVAT,TotalPaymentDiscountOnVAT);
                            //<<Ashwini
