report 50032 "CFA Request Form"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/50032_Report_CFARequestForm.rdlc';
    Caption = 'Sales - Quote';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(dectotal; dectotal + TaxAmount - TempSalesLine."Inv. Discount Amount")
            { }
            ...
            begin
                ...
                dectotal := 0;
                recsalesline2.Reset();
                recSalesLine2.SETRANGE("Document Type", "Document Type");
                recSalesLine2.SETRANGE("Document No.", "No.");
                IF recSalesLine2.FIND('-') THEN BEGIN
                    REPEAT
                        dectotal += recsalesline2."Line Amount";
