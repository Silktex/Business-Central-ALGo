report 60504 "Return Authorization Ext"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/60504_Report_ReturnAuthorization.rdl';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    TempSalesLine.INSERT;
                    HighestLineNo := "Line No.";
                    LineAmount := LineAmount + TempSalesLine."Line Amount";//Ashwini
                    DiscAmount := DiscAmount + "Sales Line"."Line Discount Amount" + "Sales Line"."Inv. Discount Amount";//Ashwini
                ...
                begin
                    ...
                    //LineAmount :=0; //Ashwini
                    DiscAmount := 0; //Ashwini
                end;
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        column(TempSalesLine_Amount; TempSalesLine."Line Amount")
                        {
                        }
                        column(TempSalesLine_LineDiscount; TempSalesLine."Line Discount Amount")
                        {
                        }
                        column(TempSalesLine_Observation; TempSalesLine.Observation)
                        {
                        }
                        column(LineAmount; TempSalesLine."Line Amount")
                        {
                        }
                        column(DiscAmount; TempSalesLine."Inv. Discount Amount")
                        {
                        }
