report 50212 "Purchase Order2."
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/50212_Report_PurchaseOrder2.rdlc';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(PUCCHhEADERcOMMENT; "Purch. Comment Line")
            {
                DataItemLink = "No." = FIELD("No.");
                DataItemTableView = SORTING("Document Type", "No.", "Document Line No.", "Line No.") WHERE("Document Line No." = FILTER(0));
                column(No_PUCCHhEADERcOMMENT; PUCCHhEADERcOMMENT."No.")
                {
                }
                column(LineNo_PUCCHhEADERcOMMENT; PUCCHhEADERcOMMENT."Line No.")
                {
                }
                column(Comment_PUCCHhEADERcOMMENT; PUCCHhEADERcOMMENT.Comment)
                {
                }
            }
