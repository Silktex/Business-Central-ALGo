report 50207 "Sales Order With Comment New"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/50207_Report_SalesOrderWithCommentNew.rdlc';
    Caption = 'Sales Order';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        column(TempSalesLineLineDiscountAmount1; TempSalesLine."Line Discount Amount" / intLineCount)
                        {
                        }
