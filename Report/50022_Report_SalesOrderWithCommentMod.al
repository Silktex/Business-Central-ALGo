report 50022 "Sales Order With Comment Mod"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/50022_Report_SalesOrderWithCommentMod.rdlc';
    Caption = 'Sales Order';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Ship_to_Code; "Sales Header"."Ship-to Code")
                    {
                    }
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        column(AmountExclInvDisc1; AmountExclInvDisc / intLineCount)
                        {
                        }
                        ...
                        column(TempSalesLineLineDiscountAmount1; TempLineDiscountAmount)
                        {
                        }
                        ...
                        column(TempSalesLineLineAmtTaxAmtInvDiscAmt1; (AmountExclInvDisc + TaxAmount - TempSalesLine."Inv. Discount Amount") / intLineCount)
                        {
                        }
            ...
            begin
                ...
                IF recSalesLine.FIND('-') THEN BEGIN
                    REPEAT
                        IF recSalesLine.Type = recSalesLine.Type::Item THEN BEGIN
                            blnComplete := TRUE
                        END;
                    UNTIL (recSalesLine.NEXT = 0) OR blnComplete;
                END;
                IF blnComplete THEN
                ...
                /*
                MESSAGE('ADD1: %1\ADD2: %2\ADD3: %3\ADD4: %4\ADD5: %5\ADD6: %6\ADD7: %7\ADD: %8',ShipToAddress[1]
                ,ShipToAddress[2],ShipToAddress[3],ShipToAddress[4],ShipToAddress[5],ShipToAddress[6],ShipToAddress[7],ShipToAddress[8]);
                */
