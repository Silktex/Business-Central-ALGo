report 70003 "Purchase Order2 POSH"
{
    DefaultLayout = RDLC;
    RDLCLayout = './POSH Report/70003_Report_PurchaseOrder2New.rdlc';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            begin
                ...
                ShipToAddress[2] := "Purchase Header"."Ship-to Address" + ' ' + "Purchase Header"."Ship-to Address 2";
                ShipToAddress[3] := "Purchase Header"."Ship-to City" + ', ' + "Purchase Header"."Ship-to Post Code";
                ShipToAddress[4] := "Purchase Header"."Ship-to County" + ', ' + "Purchase Header"."Ship-to Country/Region Code";
                ShipToAddress[5] := "Purchase Header"."Ship-to Contact";
