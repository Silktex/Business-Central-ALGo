report 70021 "Shipped Samples Without MB"
{
    DefaultLayout = RDLC;
    RDLCLayout = './POSH Report/70021_Report_ShippedSamplesReportWithoutMB.rdlc';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            RequestFilterFields = "Salesperson Code", "No.", "Shipment Date", "Location Code", "External Document No.";
            ...
            trigger OnAfterGetRecord()
            begin
                if COPYSTR("External Document No.", 1, 2) = 'MB' then
                    CurrReport.SKIP;
            ...
            begin
                ...
                SETRANGE("Posting Date", FromDate, ToDate - 1); // up to Sunday
            end;
        }
    }
