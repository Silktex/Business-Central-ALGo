// codeunit 50112 "Address Validation Testing"
// {
...
//         Xmlhttp.open('POST', 'https://ws.fedex.com/web-services', 0);
...
//         '</soapenv:Envelope>';
//         //);
//         Xmlhttp.send(textRequest);

//         MESSAGE('%1', textRequest);
//         IF ISCLEAR(locautXmlDoc) THEN
//             Result := CREATE(locautXmlDoc, TRUE, TRUE);

//         locautXmlDoc.load(Xmlhttp.responseXML);
//         //locautXmlDoc.save('C:\Tarun\XMLResponse.txt');
//         MESSAGE('%1', Xmlhttp.responseText());

//         Position1 := STRPOS(Xmlhttp.responseText(), '<StreetLines>');
//         Position1 := Position1 + 13;
//         Position2 := STRPOS(Xmlhttp.responseText(), '</StreetLines>');
//         Address := COPYSTR(Xmlhttp.responseText(), Position1, Position2 - Position1);
