report 70014 "Sales Shipment POSH"
{
    DefaultLayout = RDLC;
    RDLCLayout = './POSH Report/70014_Report_SalesShipment.rdlc';
        ...
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(SalesShipmentHeader_Project_Name; "Sales Shipment Header"."Project Name")
                    { }
            ...
            begin
                ...
                recTrackingNo.SETRANGE("Source Document No.", "Order No.");
