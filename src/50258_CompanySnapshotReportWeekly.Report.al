report 50258 "Company Snapshot Report Weekly"
{
    ProcessingOnly = true;
    ...
    begin
        ...
        txtSubject := 'Company Snapshot Report for the Week ' + FORMAT(WORKDATE - 7) + ' to ' + FORMAT(WORKDATE - 1);
        txtBody1 := '<html><body>'
                    + '<pre><p><font face = "Arial" size = "4">Dear Sir/Mam,</font></p></pre>'
                    + '<pre><p><font face = "Arial" size = "4">Please find the Company Snapshot Report for the Week ' + FORMAT(WORKDATE - 7) + ' to ' + FORMAT(WORKDATE - 1) + ', </a></font></p></pre>'
    ...
    begin
        ...
        CustLedgerEntry.SETRANGE("Posting Date", TODAY - 7, TODAY - 1);
    ...
    begin
        ...
        VendorLedgerEntry.SETRANGE("Posting Date", TODAY - 7, TODAY - 1);
