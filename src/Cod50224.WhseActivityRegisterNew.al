codeunit 50007 WhseActivityRegisterNew
{
    ...
    var
        ...
        ItemTrackingMgt: Codeunit "Item Tracking Management New";
        ...
        if TempWhseActivLineToReserve.FindSet() then
            repeat
                ...
                if ReservationEntry.FindSet() then
                    if not ReservEntryPositiveTypeIsItemLedgerEntry(ReservationEntry."Entry No.") then begin
