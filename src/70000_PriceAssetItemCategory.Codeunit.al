codeunit 70000 "Price Asset - Item Category" implements "Price Asset"
{
    var
    ...
    begin
        ...
        if PriceAsset."Variant Code" = '' then begin
            ...
            if ItemCategory.Get(PriceAsset."Asset No.") and
    ...
    begin
        ...
        //     PriceCalculationBuffer."Asset No." := 'CHAIR';
        // end;
        ItemCategory.Get(PriceCalculationBuffer."Asset No.");
        //PriceListLine."VAT Prod. Posting Group" := ItemCategory."VAT Prod. Posting Group";
        ...
        if AmountType <> AmountType::Discount then
            case PriceCalculationBuffer."Price Type" of
                PriceCalculationBuffer."Price Type"::Sale:
                    begin
                        //PriceListLine."VAT Bus. Posting Gr. (Price)" := ItemCategory."VAT Bus. Posting Gr. (Price)";
                        //PriceListLine."Price Includes VAT" := ItemCategory."Price Includes VAT";
    ...
    begin
        ...
        case PriceAsset."Price Type" of
            PriceAsset."Price Type"::Sale:
                begin
                    // PriceAsset."Allow Invoice Disc." := ItemCategory."Allow Invoice Disc.";
