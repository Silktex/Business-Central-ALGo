report 50071 "Item Customer Re-Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/50071_Report_ItemCustomerReOrder.rdlc';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            column(Item_Old_Customer; Item.Customer)
            {
            }
            ...
            begin
                //IF LastCalculationYear = 0 THEN
                // ERROR('Last Calculation Year Must not be Zero');

                Year := DATE2DMY(TODAY, 3);
                Month := DATE2DMY(TODAY, 2);
                Day := DATE2DMY(TODAY, 1);

                //Year -= LastCalculationYear;

                //MESSAGE('from Date %1 to %2',PreviousDate, TODAY);
            end;
        }
    }
    ...
    var
        ...
        ItemCustomerName2: Record "Item Customer Re-Order";
        ItemCustomerName: Record "Item Customer Re-Order";
