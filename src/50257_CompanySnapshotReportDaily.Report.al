report 50257 "Company Snapshot Report Daily"
{
    ProcessingOnly = true;
    ...
    begin
        ...
        txtSubject := 'Company Snapshot Report for the Date ' + FORMAT(WORKDATE);
        txtBody1 := '<html><body>'
                    + '<pre><p><font face = "Arial" size = "4">Dear Sir/Mam,</font></p></pre>'
                    + '<pre><p><font face = "Arial" size = "4">Please find the Company Snapshot Report for the Date ' + FORMAT(WORKDATE) + ', </a></font></p></pre>'
